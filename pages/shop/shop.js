...
Page({
  ...
  refresh() {
    ...
    this.setData({ user, currentPet: pet, availableKeys, availableMap, FEED_ITEMS: FEED_ITEMS.map(item => ({ ...item, icon: getImageUrl(item.icon) })), bgImage: getImageUrl('/images/shop-bg-new.png') });
  },
